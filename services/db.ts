...
//            https://nirogos.in — used as the emailRedirectTo
...
if (!finalUrl || !supabaseAnonKey) {
    console.error('[NirogOS] Supabase env vars missing. Ensure VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY are set.');
}
