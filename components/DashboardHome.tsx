...
import { UpgradePendingBanner } from './UpgradePendingBanner';
...
const DashboardHome: React.FC<DashboardHomeProps> = ({ clinic, onNavigate, session }) => {
    ...
    return (
        <div className="space-y-5 md:space-y-8 animate-in fade-in duration-700 slide-in-from-bottom-4 pb-24 md:pb-8">
            {/* Feature 4: Pending upgrade banner */}
            <UpgradePendingBanner clinicId={clinic?.id ?? null} />

            <div className="px-4 md:px-6 space-y-5 md:space-y-8">
