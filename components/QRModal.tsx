...
const QRModal: React.FC<QRModalProps> = ({ isOpen, onClose, clinicId, clinicName }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
            ...
            {/* Modal Card */}
            <div className="relative z-10 bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300 flex flex-col md:flex-row">
